...
def make_args():
    ...
    parser.add_argument('--walk_length', type=int, default=30, #30
                    help='Length of walk per source. Default is 80.')
    parser.add_argument('--sugraph_node_number', type=int, default=20,
                    help='sugraph_node_number'    )
    parser.add_argument('--feature_node_length', type=int, default=15,
                    help='Number of most similar nodes' )
    parser.add_argument('--subgraph_feature_downscaling_dim', type=int, default=3000,
                    help='subgraph_feature_downscaling_dim'    )
